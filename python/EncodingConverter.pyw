...
def convert(event):
    ...
    try:
        str2 = str1.encode(listbox_encode.get())
        label_encode.config(highlightcolor='sky blue',
                            highlightbackground='sky blue')
    except:
        str2 = str1.encode(listbox_encode.get(), errors='replace')
        label_encode.config(highlightcolor='red', highlightbackground='red')
    try:
        str3 = str2.decode(listbox_decode.get())
        label_decode.config(highlightcolor='sky blue',
                            highlightbackground='sky blue')
    except:
        str3 = str2.decode(listbox_decode.get(), errors='replace')
        label_decode.config(highlightcolor='red', highlightbackground='red')
